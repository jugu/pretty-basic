package com.jugu.prettybasic.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("PrettyBasic");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("PrettyBasic");
        ...
        config.getMapConfigs().put("com.jugu.prettybasic.domain.*", initializeDomainMapConfig(jHipsterProperties));
