...
@RestController
@RequestMapping("/api/pretty-basic-kafka")
public class PrettyBasicKafkaResource {
    private final Logger log = LoggerFactory.getLogger(PrettyBasicKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PrettyBasicKafkaResource(KafkaProperties kafkaProperties) {
