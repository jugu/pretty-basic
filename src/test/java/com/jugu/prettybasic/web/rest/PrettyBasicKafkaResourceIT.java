package com.jugu.prettybasic.web.rest;
...
import com.jugu.prettybasic.config.KafkaProperties;
...
class PrettyBasicKafkaResourceIT {
    ...
    void setup() {
        ...
        PrettyBasicKafkaResource kafkaResource = new PrettyBasicKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/pretty-basic-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/pretty-basic-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
